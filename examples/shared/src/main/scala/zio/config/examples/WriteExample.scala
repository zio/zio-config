...
object WriteExample extends App with EitherImpureOps {
  ...
  val readFromSource: A =
    read(description from ConfigProvider.fromMap(map, "map")).unsafeRun
