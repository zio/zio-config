...
object NestedConfigTestUtils {
  ...
  val genAppConfig: Gen[Any, AppConfig] =
    for {
      db      <- genDb
  ...
  val genNestedConfigParams: Gen[Any, TestParams] =
